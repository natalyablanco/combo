  ...
  render() {
    ...
    const tileData = [
      ...
      },
      {
        ...
        bio: "Fanis Gioles zählt zu den vielversprechendsten griechischen Schlagzeugern der jungen Genenation.  Geboren 1988 in Athen, begann er  im Alter von fünf Jahren mit dem Violinspiel, bevor er im Alter von zehn mit dem Schlagzeugspielen anfing.\
